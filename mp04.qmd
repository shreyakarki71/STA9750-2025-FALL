...
### Inspect the number of missing values across key fields
...
### Display example rows containing missing or malformed values
...
### Verify that all expected years are represented
...
### Filter out incomplete rows and restrict to the 1979–2025 analysis period
...
## 2. Schematic Visualization: How Computational Methods Work
