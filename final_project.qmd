...
knitr::include_graphics("data/final_project/monthly_complaints.png")
```
...
knitr::include_graphics("data/final_project/weather_type.png")
```
...
knitr::include_graphics("data/final_project/bivarate relationship.png")
```
...
knitr::include_graphics("data/final_project/demographic predictors.png")
```
...
knitr::include_graphics("data/final_project/park land.png")
```
...
knitr::include_graphics("data/final_project/park rat distribution .png")
...
knitr::include_graphics("data/final_project/blue char.png")
```
...
```{r}
knitr::include_graphics("data/final_project/predicted_vs_actual_group1.png")
```
...
```{r}
knitr::include_graphics("data/final_project/predicted_vs_actual_group5.png")
```
...
knitr::include_graphics("data/final_project/restaurant_rodent_density_map.png")
```
...
knitr::include_graphics("data/final_project/outdoor_seating_vs_complaints.png")
```
...
knitr::include_graphics("data/final_project/spatial_scale_effects.png")
```
...
knitr::include_graphics("data/final_project/spatial_aggregation_distortion.png")
