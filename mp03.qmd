...
```{r tree_density}
# Calculate tree density per district 
...
```
**Finding**: The species `r manhattan_trees$genus_species[1]` the most common in Manhattan, with `r manhattan_trees$count[1]` recorded trees.
...
#  District 4 and 3 Manhattan peer districts
target_district      <- 4
