...
```{r vulnerability_analysis, message=FALSE, warning=FALSE}
...
# District 4 Climate-Resilient Canopy Initiative {#district-4-climate-resilient-canopy-initiative}
...
```{r show_vulnerability_chart, fig.width=8, fig.height=5, dpi=220}
...
```{r show_map, fig.width=6.2, fig.height=6.6, dpi=220}
...
This work ©2025 was initially prepared as a Mini-Project for <strong>STA 9750</strong> at <strong>Baruch College</strong>.<br>More details about the course can be found at the <a href="https://michael-weylandt.com/STA9750/">course site</a>, and full assignment instructions are available under <a href="https://michael-weylandt.com/STA9750/miniprojects/mini03.html">Mini-Project #03</a>.
:::
